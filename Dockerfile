...
# install graphite
RUN git clone -b 1.1.5 --depth 1 https://github.com/graphite-project/graphite-web.git /usr/local/src/graphite-web
...
# install whisper
RUN git clone -b 1.1.5 --depth 1 https://github.com/graphite-project/whisper.git /usr/local/src/whisper
WORKDIR /usr/local/src/whisper
RUN python ./setup.py install

# install carbon
RUN git clone -b 1.1.5 --depth 1 https://github.com/graphite-project/carbon.git /usr/local/src/carbon
